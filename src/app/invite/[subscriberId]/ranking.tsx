    ...
    <div className="w-full max-w-[440px] space-y-5">
      ...
      <div className="space-y-4">
        {ranking.map((item, index) => {
          ...
          return (
            <div key={item.id} className="relative roundede-xl bg-gray-700 border border-gray-600 p-6 flex - flex-col justify-center gap-3">
...
{/*         <div className="relative roundede-xl bg-gray-700 border border-gray-600 p-6 flex - flex-col justify-center gap-3">
          <span className="text-sm text-gray-300 leading-none">
            <span className="font-semibold">1º</span> | Luiz Almada
          </span>
          <span className="font-heading text-2xl font-semibold text-gray-200 leading-none">
            1030
          </span>
        ...
        <div className="relative roundede-xl bg-gray-700 border border-gray-600 p-6 flex - flex-col justify-center gap-3">
          <span className="text-sm text-gray-300 leading-none">
            <span className="font-semibold">3º</span> | José da Silva
          </span>
          <span className="font-heading text-2xl font-semibold text-gray-200 leading-none">
            890
          </span>
